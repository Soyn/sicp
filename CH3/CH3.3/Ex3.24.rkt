...
;;
;; Exercise3.24
;; Created by Soyn. 22/9/15
;; @Brief:In the table implementations above, the keys are tested for equality using equal? (called
...
( define ( make-table same-key?)                ;; all we need to change the 'assoc' procedure
